...
public struct PublicKeyCredentialCreationOptions: Codable, Sendable {
	...
	public init(challenge: [UInt8], user: PublicKeyCredentialUserEntity, relyingParty: PublicKeyCredentialRelyingPartyEntity, publicKeyCredentialParameters: [PublicKeyCredentialParameters], timeout: Duration?, attestation: AttestationConveyancePreference) {
...
extension PublicKeyCredentialRelyingPartyEntity : Equatable {}
